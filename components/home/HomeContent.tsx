        ...
        <div className="hp-section-wrap">
          ...
          <div className="hp-ref-grid">
            {[
              ...
              { file: "national-geographic-kids.jpg", label: "National Geographic Kids" },
              { file: "fortune.jpg",                  label: "Fortune" },
              { file: "robb-report.jpeg",             label: "Robb Report" },
              { file: "istanbullife.webp",            label: "Istanbul Life" },
              { file: "marie-claire.jpg",             label: "Marie Claire" },
              { file: "marieclairekids.png",          label: "Marie Claire Kids" },
              { file: "marieclaire-maison.jpeg",      label: "Marie Claire Maison" },
              { file: "marieclaire-weddings.jpeg",    label: "Marie Claire Weddings" },
              ...
              { file: "instyle.jpeg",                 label: "InStyle" },
              { file: "instylehome.jpeg",             label: "InStyle Home" },
              { file: "psychologies.jpg",             label: "Psychologies" },
              { file: "marieclaire-man.jpg",          label: "Marie Claire Man" },
              { file: "lezzet.jpeg",                  label: "Lezzet" },
              { file: "bluejean.jpeg",                label: "Bluejean" },
              { file: "atlas.webp",                   label: "Atlas" },
              { file: "evim.jpeg",                    label: "Evim" },
              { file: "weddings.jpeg",                label: "Weddings" },
